...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kchassisRadiusMeters = Math.pow(Math.pow(kTrackWidth, 2) + Math.pow(kWheelBase, 2), 0.5)
        * 0.0254;
  ...
  public static final class AutoConstants {
    ...
    public static final HolonomicPathFollowerConfig autoBuilderPathConfig = new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig,
                                                                                                             // this
                                                                                                             // should
                                                                                                             // likely
                                                                                                             // live in
                                                                                                             ...
                                                                                                             // Constants
                                                                                                             // class
        new PIDConstants(3.5, 0.0, 0.2), // original p = 5, 1st attempt: p = 5, d = 0.5, 2nd attempt: p= 5, d = 0.5, 3rd
                                         // attempt: p = 5, d = 3 this caused the wheels to shutter
        new PIDConstants(3, 0.0, 0), // 5.0, 0, 0.2
        DriveConstants.kMaxSpeedMetersPerSecond, // Max module speed, in m/s
        DriveConstants.kchassisRadiusMeters, // Drive base radius in meters. Distance from robot center to furthest
                                             // module.
  ...
  public static final class Vision {
    ...
    // from center.
    public static final Transform3d kRobotToAprilTagCam = new Transform3d(new Translation3d(0.5, 0.0, 0.5),
        new Rotation3d(0, 0, 0));
    public static final Transform3d kRobotToNoteCam = new Transform3d(new Translation3d(0.5, 0.0, 0.5),
        new Rotation3d(0, 0, 0));
  ...
  public static class FieldConstants {
    ...
    // public static final Translation2d BLUE_SPEAKER = new Translation2d(0.0241 +
    // 0.1, 5.547868 + -0.04);
    // public static final Translation2d RED_SPEAKER = new
    // Translation2d(FIELD_LENGTH - BLUE_SPEAKER.getX(),
    // BLUE_SPEAKER.getY() + 0.1);
    ...
    // public static final Pose3d BLUE_SPEAKER_3D = new Pose3d(BLUE_SPEAKER.getX(),
    // BLUE_SPEAKER.getY(), SPEAKER_HEIGHT,
    // new Rotation3d());
    // public static final Pose3d RED_SPEAKER_3D = new Pose3d(RED_SPEAKER.getX(),
    // RED_SPEAKER.getY(), SPEAKER_HEIGHT,
    // new Rotation3d());

    // public static final double OPPONENT_WING_LINE = 10.66;
    // public static final double AMP_X = 1.9;

    // public static final PIDConstants AUTO_AIM_ROT_PID_CONSTANTS = new
    // PIDConstants(9.5, 0.01, 0.5);
    // public static final PIDConstants AUTO_AIM_ROT_PID_CONSTANTS_TELE = new
    // PIDConstants(10.5, 0.01, 0.5);

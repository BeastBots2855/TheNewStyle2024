...
public class SetIntakeToShooterPosition extends SequentialCommandGroup {
  /** Creates a new SetIntakeToShooterPosition. */
  public SetIntakeToShooterPosition(ShooterWrist m_ShooterWrist, IntakeWrist m_IntakeWrist) {
